...
const UpcomingMatches = () => {
  return (
    <div className="bg-UpcomingHero bg-black w-full bg-no-repeat bg-auto bg-center flex justify-center flex-col items-center h-[400px] font-mono">
      <h1 className="text-white text-4xl ">Upcoming Match</h1>
